...
const FeedbackCard = ({feedback}:any) => {
  return (
    <div className='relative rounded bg-Blue px-8 md:px-10 pb-6 pt-12 w-[19rem] md:w-[36rem]'>
        <div className='absolute right-28 md:right-64 -top-10 z-40'>
            <Image src={feedback.imageUrl} height={70} width={70}/>
        </div>
        <p className='text-white text-base md:text-sm md:pr-10 leading-stretch md:leading-normal md:h-24'>“{feedback.feedback}”</p>
