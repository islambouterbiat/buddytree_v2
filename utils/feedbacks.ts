...
export const feedbacks:Array<Card>=[
    ...
    {id:2,user:"Glen", place:"California",feedback:"ningful discussions with interesting people around the world in the comfort of your own home.",imageUrl:user,tags:["Get moving","Share language + culture","Read with freinds","Write together"]},
    {id:3,user:"Glen", place:"California",feedback:"Buddytaningful discussions with interesting people around the world in the comfort of your own home.",imageUrl:user,tags:["Get moving","Share language + culture","Read with freinds","Write together"]},
    {id:4,user:"Glen", place:"California",feedback:"Buddytreort of your own home.",imageUrl:user,tags:["Get moving","Share language + culture","Read with freinds","Write together"]},
    ...
    {id:6,user:"Glen", place:"California",feedback:"Buddytree combines the coful discussions with interesting people around the world in the comfort of your own home.",imageUrl:user,tags:["Get moving","Share language + culture","Read with freinds","Write together"]},
